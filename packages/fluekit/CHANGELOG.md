...
- **AlertDialog**: Added `showAlertDialog` helper for imperative usage.
...
- **BoxConstraints**: Added `BoxConstraints.tightFor` helper method.

## [2.5.1] - 2026-01-26

### Documentation

- **BoxDecoration**: Added documentation and demo for `backdropFilter` (Glassmorphism).
...
- **StyleProvider**: Export `StyleProvider` component and add documentation.
